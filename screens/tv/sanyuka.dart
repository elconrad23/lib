...
class Sanyuka extends StatefulWidget {
  const Sanyuka({Key? key}) : super(key: key);
...
class _SanyukaState extends State<Sanyuka> {
  ...
  //     "http://197.239.30.29/readymedia/stream/tvSanyuka_tv/20-hls/live-media.m3u8",
  //     hwAcc: HwAcc.FULL,
  //     autoPlay: false,
      ...
      home: Scaffold(
        appBar: fullscreen == false
          ? AppBar(
              ...
              title: const Image(
                image: AssetImage('assets/images/sanyuka.jfif'),
